...
class StunMotion():
    """A StunMotion alters the motion of a model based on its current 
    velocity state. It is used to determine the acceleration of a model when
    it a player is stunned. At instantiation it takes in acceleration vector 
    and a velocity vector that define the maximum acceleration and velocity 
    allowed.  The components of the velocity and acceleration vectors should
    have the same sign."""
