...
class Input:
    ...
    def __init__(self, **options):
        ...
        self.options = Config(options, ['x', '0'], ['y', '0'], ['font', 'pygame.font.Font(\'freesansbold.ttf\', 32)'],
    ...
    def update(self, events):
        ...
        previous_length = len(self.prompt+self.value)
        previous_font_height = self.font.get_height()
        ...
        if ((previous_length != len(self.prompt+self.value)) or
            (previous_font_height != self.font.get_height())):
            text_dimensions = self.font.size(self.prompt+self.value)
